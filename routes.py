...
def admin_approve_schedule(schedule_id):
    ...
    change = ChangeLog(
        ...
        field_changed='schedule_approve',
        old_value='pending',
        new_value='approved'
    )
    db.session.add(change)
...
def admin_approve_attendance(attendance_id):
    ...
    change = ChangeLog(
        ...
        field_changed='attendance_approve',
        old_value='pending',
        new_value='confirmed'
    )
    db.session.add(change)
...
def admin_reject_attendance(attendance_id):
    ...
    change = ChangeLog(
        user_id=current_user.id,
        target_user_id=attendance.user_id,
        field_changed='attendance_reject',
        old_value='pending',
        new_value='rejected'
    )
    db.session.add(change)
